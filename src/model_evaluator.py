...
# Example usage with a sample dataset and model
if __name__ == "__main__":
    ...
    # Initialize model evaluator with the regression evaluation strategy
    ...
    print("Final Model Evaluation Metrics:", evaluation_metrics)
